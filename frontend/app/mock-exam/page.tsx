...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  header: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0.7rem 1.5rem", background: "#ffffff", borderBottom: "1px solid #e2e8f0" },
  ...
  body: { display: "flex", maxWidth: "1000px", margin: "0 auto", padding: "1.5rem", gap: "1.5rem" },
  sidebar: { width: "210px", flexShrink: 0, background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: "12px", padding: "1.2rem", height: "fit-content" },
  ...
  questionCard: { background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: "12px", padding: "1.8rem" },
  ...
  actionRow: { display: "flex", justifyContent: "space-between", alignItems: "center", background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: "12px", padding: "1rem 1.2rem" },
