...
interface ExaminerShellProps {
  children: ReactNode;
  title: string;
}

export default function ExaminerShell({ children, title }: ExaminerShellProps) {
  const pathname = usePathname();
  const [examinerName, setExaminerName] = useState("examiner2");
  ...
  useEffect(() => {
    const savedTheme = (localStorage.getItem("theme_mode") || localStorage.getItem("examiner_theme")) as "light" | "dark" | null;
  ...
  const toggleTheme = () => {
    ...
    localStorage.setItem("examiner_theme", nextTheme);
  ...
  const navItems = [
    ...
    { label: "Question Libraries", href: "/examiner/questions", icon: BookOpen },
    { label: "Exams", href: "/examiner/exams", icon: FileText },
    { label: "Mock Exams", href: "/examiner/mock-exams", icon: FlaskConical },
    { label: "Students", href: "/examiner/students", icon: Users },
    { label: "Assign Exams", href: "/examiner/assign", icon: Send },
    { label: "Live Monitoring", href: "/examiner/live-monitor", icon: Eye },
    { label: "AI Evaluation", href: "/examiner/grading", icon: Bot },
    { label: "Results", href: "/examiner/results", icon: BarChart2 },
    { label: "Profile", href: "/examiner/profile", icon: User },
  ];
